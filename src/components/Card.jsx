          ...
          <div className='bg-[#2b2b2bb2] w-full h-full z-10 fixed top-0 left-0 flex flex-col items-center justify-center' >
            <div className='w-80 h-40 bg-[#809475] z-20 flex flex-col justify-center items-center shadow-2xl rounded-md' >
              ...
              <div className='flex justify-between gap-10 items-center mt-6' >
                <button className='bg-[#d52a2a] p-1 rounded-md shadow-md w-10 hover:scale-105' onClick={handleFinalDelete}>
                  Yes
                </button>
                <button className='bg-[#3a603e] p-1 rounded-md shadow-md w-10 hover:scale-105' onClick={() => setDeletePopup(false)} >
                  No
                </button>
              </div>
            </div>
...

        {
          ...
          isProfile ? (
            <div className='w-full flex justify-end items-end' >
              <button className='text-[#7c7979] bg-gray-800 flex justify-center items-center w-8 h-8 rounded-md hover:cursor-pointer hover:text-[#cd1818] max-xs:text-[#cd1818]'
