...
const Login = () => {
   ...
   const mongoAddUser = async (doc) => {
      ...
      try {
         ...
         const response = await fetch('https://artilligence.onrender.com/api/v1/user-x', {
            method: 'POST',
   ...
   return (
      <div className='w-full h-[100vh] flex flex-col justify-center items-center'>
         <div className='w-96 h-96 bg-[#809475] flex flex-col justify-center items-center absolute top-[25%] shadow-2xl' >
            ...
            <GoogleLogin onSuccess={googleResponse} onError={() => console.log("ERROR")} referrerPolicy="no-referrer" />
